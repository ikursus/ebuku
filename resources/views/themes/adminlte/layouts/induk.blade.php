...
<!-- Font Awesome -->
<link rel="stylesheet" href="{{ asset('themes/adminlte') }}/bower_components/font-awesome/css/font-awesome.min.css">
<!-- Ionicons -->
...
<!-- /.content-wrapper -->
@include('themes.adminlte.layouts.footer')

<!-- Control Sidebar -->
@include('themes.adminlte.layouts.control_sidebar')
<!-- /.control-sidebar -->
